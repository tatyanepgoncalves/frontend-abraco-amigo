...
function Card({
  ...
  return (
    <div
      className={cn(
        'group/card flex flex-col gap-4 overflow-hidden rounded-xl bg-card px-4 py-8 text-card-foreground text-sm ring-1 ring-foreground/10 has-[>img:first-child]:pt-0 has-data-[slot=card-footer]:pb-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl',
        className
      )}
      data-size={size}
      data-slot="card"
