...
export default function CardLocais({ locais }: CardLocaisProps) {
  return (
    <article className="flex flex-col justify-between space-y-4 rounded-xl bg-card shadow-sm transition-all hover:shadow-md dark:bg-zinc-800">
